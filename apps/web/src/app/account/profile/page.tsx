...
export default function ProfilePage() {
  ...
  return (
    <div className="space-y-8">
      <h1 className="font-display text-2xl">Profile & Password</h1>
      ...
      <form onSubmit={handleProfileSubmit} className="card space-y-4 p-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            <input className="input bg-ink/5" value={user.phone ?? ""} disabled />
            <p className="mt-1 text-xs text-ink/40">Your phone number is your login ID and can't be changed here — contact support if it needs updating.</p>
          </div>
        </div>
